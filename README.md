...
An STM32-based automotive safety system that detects vehicle crashes using MPU6050 accelerometer data. Real-time GPS location alerts are sent over MQTT using ESP8266. Crash events are logged into EEPROM to mimic automotive black-box systems used in ADAS applications.
